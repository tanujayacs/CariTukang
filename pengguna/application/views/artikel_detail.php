<section class="container my-5 pt-5">  
    <div class="row mb-5">  
        ...
        <p><?php echo $detail_artikel->isi_artikel; ?></p>  
    </div>  
            ...
            <div class="row">  
                <?php foreach ($recommended_articles as $recommended_article): ?>  
                    <div class="col-12 col-md-4 mb-3">  
                        <div class="card border-0 text-center"> <!-- Center the card content -->  
                            <img src="<?php echo $this->config->item('url_artikel') . $recommended_article->foto_artikel; ?>" class="card-img-top" alt="Artikel">  
                            <div class="card-body">  
                                <h5 class="card-title"><?php echo $recommended_article->judul_artikel; ?></h5>  
                                <a href="<?php echo site_url('artikel/detail/' . $recommended_article->id_artikel); ?>" class="btn btn-primary">Baca Selengkapnya</a>  
                            </div>  
                        </div>  
                    </div>  
                <?php endforeach; ?>  
